      ...
      <div className="container-shell">
        ...
        <div className="mt-8 grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:gap-20">
          ...
          <div className="surface-card self-start p-6 md:p-8">
            <p className="text-xs font-bold uppercase tracking-[0.12em] text-[var(--text-muted)]">{t("philosophy_label")}</p>
            <p className="mt-4 text-lg leading-8 text-[var(--text)]">{t("philosophy_text")}</p>
